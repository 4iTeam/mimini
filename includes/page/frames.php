 ...
 *    mostly ignored. Implements the MiminiPage
 *    interface so as to be interchangeable.
 * @package Mimini
 * @subpackage Browser
 */
class MiminiFrameset
{
    private $frameset;
    /**
     * @var array|MiminiPage[]
     */
    private $frames;
    private $focus;
    private $names;
     ...
     * @param MiminiPage $page Frameset page.
     */
     ...
     * @param MiminiPage $page Frame page.
     * @param string $name Name of frame in frameset.
     * @access public
     */
    function addFrame($page, $name = null)
    {
        $this->frames[] = $page;
        if ($name) {
     ...
     * @param MiminiPage $page Frame source.
     * @access public
     */
     ...
     * @param MiminiUrl $url Relative URL.
     ...
     * @param MiminiUrl[] $urls List of MiminiUrls.
     ...
     * @return MiminiForm    Form object containing the matching ID.
     * @access public
     */
     ...
     * @param MiminiPage $page Page content of frame.
    ...
    protected function findFormInFrame($page, $index, $method, $attribute)
    {
        ...
        if (isset($form) && $form instanceof MiminiForm) {
