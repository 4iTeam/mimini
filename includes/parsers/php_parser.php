...
class MiminiLexer
{
     ...
     *    by default.
     * @param MiminiHtmlSaxParser $parser Handling strategy by
     *                                    reference.
    ...
    function __construct($parser, $start = "accept", $case = false)
    {
        ...
        $this->regexes = array();
        $this->parser = $parser;
        $this->mode = new MiminiStateStack($start);
 ...
 * @subpackage Browser
 */
class MiminiHtmlLexer extends MiminiLexer
{
...
class MiminiHtmlSaxParser
{
    ...
    /**
     *    Sets the listener.
     * @param MiminiPhpPageBuilder $listener SAX event handler.
     * @access public
     */
     ...
     * @param MiminiHTMLSaxParser $parser Event generator, usually $self.
     * @return MiminiLexer               Lexer suitable for this parser.
     * @access public
     */
    static function createLexer(&$parser)
    {
        return new MiminiHtmlLexer($parser);
    }
 ...
 * @subpackage Browser
 */
class MiminiPhpPageBuilder implements MiminiParserInterface
{
    private $tags;
    private $page;
     ...
     * @param $response MiminiHttpResponse  Fetched response.
     * @param MiminiBrowser $browser
     * @return MiminiPage                   Newly parsed page.
     * @access public
     */
    function parse($response,$browser)
    {
        $this->tags = array();
        $this->page = $this->createPage($response,$browser);
     ...
     * @param MiminiBrowser $browser
     * @return MiminiPage        New unparsed page.
     * @access protected
     */
    protected function createPage($response,$browser)
    {
        return new MiminiPage($response,$browser);
    }

    /**
     *    Creates the parser used with the builder.
     * @param MiminiPhpPageBuilder $listener Target of parser.
     * @return MiminiSaxParser              Parser to generate
     *                                         events for the builder.
     * @access protected
     */
    protected function createParser(&$listener)
    {
        return new MiminiHtmlSaxParser($listener);
    }
     ...
     *    fields only.
     * @param MiminiTag $tag Option tags only.
     * @access private
     */
     ...
     * @param MiminiTag $tag New content tag.
     * @access private
     */
     ...
     * @param MiminiTag $tag Tag to accept.
     * @access public
     */
     ...
     * @param MiminiFormTag $tag Tag to accept.
     * @access public
     */
    ...
    protected function acceptLabelEnd()
    {
        if (isset($this->label)) {
            if (isset($this->last_widget)) {
                ...
                $this->left_over_labels[] = MiminiCompatibility::copy($this->label);
            }
            unset($this->label);
        }
    }
    ...
    {
        $this->open_forms[] = new MiminiForm($tag, $this->page);
    }
     ...
     * @param MiminiFrameTag $tag Tag to accept.
     * @access public
     */
