 ...
 * @subpackage Browser
 */
class MiminiEncoding
{
    /**
     * @var MiminiEncodedPair[]
     */
    private $request;
    ...
    {
        $this->request[$key] = new MiminiEncodedPair($key, $value);
    }
    ...
    {
        $this->request[] = new MiminiAttachment($key, $content, $filename);
    }

    /**
     *    Adds a set of parameters to this query.
     * @param array|MiminiEncoding $query  Multiple values are
     *                                           as lists on a single key.
     * @access public
     */
     ...
     * @return MiminiEncodedPair[]      All pair objects.
     * @access public
     */
    function getAll()
    {
 ...
 * @subpackage Browser
 */
class MiminiGetEncoding extends MiminiEncoding
{
     ...
     * @param MiminiSocket $socket Socket to write to.
     * @access public
     */
 ...
 * @subpackage Browser
 */
class MiminiHeadEncoding extends MiminiGetEncoding
{
 ...
 * @subpackage Browser
 */
class MiminiDeleteEncoding extends MiminiGetEncoding
{
 ...
 * @subpackage Browser
 */
class MiminiEntityEncoding extends MiminiEncoding
{
     ...
     * @return string Encoded entity body
     * @access protected
     */
    public function encode()
    {
 ...
 * @subpackage Browser
 */
class MiminiPostEncoding extends MiminiEntityEncoding
{

    /**
     *    Starts empty.
     * @param array|MiminiEncoding $query Hash of parameters.
     *                              Multiple values are
     *                              as lists on a single key.
     * @param string $content_type
     * @access public
     */
    function __construct($query = null, $content_type = null)
    {
 ...
 * @subpackage Browser
 */
class MiminiPutEncoding extends MiminiEntityEncoding
{
 ...
 * @subpackage Browser
 */
class MiminiMultipartEncoding extends MiminiPostEncoding
{
    private $boundary;
     ...
     *                              Multiple values are
     *                              as lists on a single key.
     * @param string|boolean $boundary
     * @access public
     */
    function __construct($query = null, $boundary = false)
    {
        parent::__construct($query);
