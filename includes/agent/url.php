...
class MiminiUrl
{
     ...
     * @return MiminiGetEncoding    Parsed data.
     * @access private
     */
    protected function parseRequest($raw)
    {
        $this->raw = $raw;
        $request = new MiminiGetEncoding();
     ...
     * @access public
     */
    function setCoordinates($x = null, $y = null)
    {
        if (($x === null) || ($y === null)) {
            $this->x = $this->y = null;
            return;
     ...
     * @param MiminiEncoding $parameters   Additional
     *                                                parameters.
     * @access public
     */
    ...
    {
        $this->raw = false;
        $this->request = new MiminiGetEncoding();
    }
     ...
     *    be either a string or a MiminiUrl object.
     * @param string|MiminiUrl $base       Base URL.
     * @return MiminiUrl
     * @access public
     */
    function makeAbsolute($base)
    {
        ...
        $coords = $this->getX() === null ? '' : '?' . $this->getX() . ',' . $this->getY();
        return new MiminiUrl("$scheme://$identity$host$port$path$encoded$fragment$coords");
    }
    ...
    /**
     *    Mimini test to see if a path part is relative.
